...
Import-PfxCertificate -Password $securePfxPass -CertStoreLocation Cert:\LocalMachine\My -FilePath c:\inetpub\wwwroot\aspnetapp.pfx   

$pfxThumbprint = (Get-PfxData -FilePath c:\inetpub\wwwroot\aspnetapp.pfx -Password $securePfxPass).EndEntityCertificates.Thumbprint
